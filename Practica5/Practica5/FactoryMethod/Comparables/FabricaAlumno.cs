...
namespace Practica_3.FactoryMethod.Comparables
{
	...
	{
		protected List<string> apellidosVariados = new List<string>
		{
			"Cabrera","Gonzalez","Altamura","Perez","Gomez",
			"Perez","Diaz","Bobadilla","Campdepadros","Fariña"
		};
		protected string apellido;
		protected int legajo;
		protected double promedio;
		protected int ultimaCalificacion;
		...
		public override Comparable crearAleatorio(){
			...
			return new Alumno(nombresVariados[new Random().Next(0,nombresVariados.Count)],apellidosVariados[new Random().Next(0,apellidosVariados.Count)] ,new Random().Next(30000000, 55000000),new Random().Next(1453,3200),(new Random().NextDouble())*10,new Random().Next(0,11));
		}
		...
		public override Comparable crearPorTeclado(){
			...
			return new Alumno(nombre,apellido,dni,legajo,promedio,ultimaCalificacion);
