...
{
	public class AlumnoAdaptador:Student,Comparable
	{
		...
		public bool equals(Student student){
			return alum1.sosIgual(((Comparable)((AlumnoAdaptador)student).getAlumno()));
		}
		
		public bool lessThan(Student student){
			return alum1.sosMenor(((Comparable)((AlumnoAdaptador)student).getAlumno()));
		}
		public bool greaterThan(Student student){
			return alum1.sosMayor(((Comparable)((AlumnoAdaptador)student).getAlumno()));
		}
